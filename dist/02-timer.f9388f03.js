...
const options = {
    ...
    onClose (selectedDates) {
        if (intervalId === null) startTimerBtn.disabled = false;
        else {
            startTimerBtn.disabled = true;
            (0, _notiflixDefault.default).Notify.warning("Reload the page to play the new timer");
        }
    }
};
...
function onStart() {
    ...
    if (intervalId === null) {
        ...
        (0, _notiflixDefault.default).Notify.success("Timer ON");
        startTimerBtn.disabled = true;
    }
}
